...
<div id="page" class="site">
			...
			<div class="flex flex-col md:flex-row justify-between items-center">
				<div class="site-branding mb-4 md:mb-0">
					...
					if ( $cec_paywall_theme_description || is_customize_preview() ) :
						?>
						<p class="site-description text-gray-600 mt-1"><?php echo $cec_paywall_theme_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
					<?php endif; ?>
				</div><!-- .site-branding -->
	...
	<div id="content" class="site-content container mx-auto px-4 py-8">
